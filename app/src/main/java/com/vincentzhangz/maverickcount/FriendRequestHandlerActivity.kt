                    ...
                    dialogBuilder.setPositiveButton(
                        ...
                        dbFriend.child("name")
                            .addValueEventListener(object : ValueEventListener {
                                ...
                                override fun onDataChange(ds: DataSnapshot) {
                                    dbUser.child("friends").child(data.data.from).setValue(
                                        Friend(
                                            data.data.from, ds.getValue(
                                                String()::class.java
                                            ).toString()
                                        )
                                    )
                        ...
                        dbUser.child("name")
                            .addValueEventListener(object : ValueEventListener {
                                ...
                                override fun onDataChange(ds: DataSnapshot) {
                                    dbFriend.child("friends").child(data.data.to).setValue(
                                        Friend(
                                            data.data.to, ds.getValue(
                                                String()::class.java
                                            ).toString()
                                        )
                                    )
